...
/**
 * BaseJdbcDao for EntityFee models and repositories
 * provides protected method {@code findBaseFee(String sql, Object... args)}
 * to prevent DRY code for finding fees.
 * <b> Also, columns {@code fee} and {@code is_allowed} are included
 * @param <E> EntityFeeModel
 */
